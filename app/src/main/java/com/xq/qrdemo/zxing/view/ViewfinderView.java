...
package com.xq.qrdemo.zxing.view;
...
import com.xq.qrdemo.R;
import com.xq.qrdemo.zxing.camera.CameraManager;
...
public final class ViewfinderView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			String scan_text = getResources().getString(R.string.scan_text);// 扫描框提示文字
			// paint.measureText(scan_text)：获取文字像素长度
			canvas.drawText(scan_text, (width - paint.measureText(scan_text)) / 2,
